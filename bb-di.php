...
$di['2faA_authenticator'] = function () use ($di) { return new twoFaAuthenticator();};
$di['google_login'] = function () use ($di) { return new Google_Client();};
$di['google_oauth'] = $di->protect(function ($client) use($di) {
