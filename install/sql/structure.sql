...
CREATE TABLE `product` (
  ...
  `updated_at` datetime DEFAULT NULL,
  `type` varchar(255) DEFAULT NULL,
  `priority_support` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `slug` (`slug`),
...
-- ----------------------------
-- Table structure for `customfieldsvalues`
-- ----------------------------
...
-- ----------------------------
-- Records of customfieldsvalues
-- ----------------------------


-- ----------------------------
-- Table structure for `tickets_logs`
-- ----------------------------
