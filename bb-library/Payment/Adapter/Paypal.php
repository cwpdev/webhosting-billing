<?php
class Payment_Adapter_Paypal implements \Box\InjectionAwareInterface
{
    ...
    public static function getConfig()
    {
        return array(
            ...
            'form'  => array(
                'clint_id' => array('text', array(
                    'label' =>' CLIENT_ID',
                    'description' => 'Enter CLIENT_ID generated from paypal api',
                ),
                ),

                'app_secret' => array('text', array(
                    'label' =>' APP_SECRET',
                    'description' => 'Enter CLIENT_ID generated from paypal api',
                ),
                ),
                'sandbox' => array('radio', array(
                    'multiOptions' => array('1'=>'Yes', '0'=>'Not'),
                    'label' => 'SANDBOX',
                ),
                ),
            ),
    ...
    private function _generateForm($url, $data, $method = 'post')
    {
        ...
        <script src="https://www.paypal.com/sdk/js?client-id=ATkUPCR2A7o3xJ5nFOQV3Y-m_bnhgpnetwtuxjSb1GWU4-eC5lxjiUTw6ccL1gk4poZA6MGOCTa2B4VP&currency=USD&intent=capture&enable-funding=venmo"></script>
        <script>
