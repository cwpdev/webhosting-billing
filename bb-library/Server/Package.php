...
class Server_Package
{
    ...
    public function getPackagesAllValues(){ 
        return [
            'name' => $this->name,
            'quota' => $this->quota,
            'bandwidth' => $this->bandwidth,
            'maxdomains' => $this->maxdomains,
            'maxsubdomains' => $this->maxsubdomains,
            'maxparkeddomains' => $this->maxparkeddomains,
            'maxftp' => $this->maxftp,
            'maxsql' => $this->maxsql,
            'maxpop' => $this->maxpop,
        ];
    }
    public function getPackagesAllCustomValues(){
        return is_array($this->custom) ? $this->custom : [];
    }
