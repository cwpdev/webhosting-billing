...
function getLicense(){
    global $config;
    $remove=str_replace("http://","",$config['url']);
    $remove=str_replace("https://","",$remove);
    $arrayDomain=explode("/",$remove);
    $curl = curl_init();

    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://cwp-billing.studio4host.com/api/guest/servicelicense/checkwhb',
        ...
        CURLOPT_POSTFIELDS => array('license' => $config['license_key'],
...
//$license=getLicense();
//$license->error ='';
define('WHB_TYPE',"DEMO");
define('WHB_LICENSE',false);
define('MAX_CLIENTS',10);
define('MAX_PRODUCTS',10);

/*if($license->error==''){
    define('WHB_LICENSE',true);
    define('MAX_CLIENTS',false);
    define('MAX_PRODUCTS',false);
    define('WHB_TYPE',$license->type);
}else{
    define('WHB_TYPE',"DEMO");
    define('WHB_LICENSE',false);
    define('MAX_CLIENTS',10);
