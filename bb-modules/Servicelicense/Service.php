...
class Service implements InjectionAwareInterface
{
    ...
    public function getConfigLicense(\Model_ServiceLicense $model)
    {
        $prderService = $this->di['mod_service']('order');
        $o = $prderService->getServiceOrder($model);
        return $prderService->getConfig($o);
    }
     ...
     * @return array
     */
    public function checkLicenseWHB(array $data)
    {
        $log = $this->di['logger'];
