...
class Admin extends \Api_Abstract
{
    ...
    public function resend_welcome($data){
        $required = array(
            'id'    => 'Order id is missing',
        );
        $this->di['validator']->checkRequiredParamsForArray($required, $data);
        $order = $this->di['db']->getExistingModelById('ClientOrder', $data['id'], 'Order not found');
        return $this->getService()->resendWelcomeEmail($order);
    }
    /**
