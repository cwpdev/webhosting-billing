...
class Client extends \Api_Abstract
{
    ...
    public function member_2fainfo(){
        $model = $this->di['db']->getExistingModelById('Client', $this->getIdentity()->id, 'Client not found');
        return [
    ...
    public function get_2fainfo(){
        ...
        $qrCodeUrl = $aunthenticator_2fa->getQR('Client area (' . $client->email .')', $secret, $company_name);
    ...
    public function update_2fa($data){
        ...
        $model->twofactor_secret = $data['twofactor_status'] == 'enabled' ? $this->di['session']->get('2fa_secret') : null;
